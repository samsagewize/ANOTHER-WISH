  ...
  return (
    <div id="intro" className="relative w-full h-[calc(100vh-48px)] min-h-[560px] overflow-hidden cursor-pointer select-none" onClick={onPlunge}>
      ...
      <div className="intro-overlay absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none p-8">
        ...
        <div className="intro-badge inline-flex flex-col items-center gap-2 bg-[rgba(245,200,66,0.07)] border border-[rgba(245,200,66,0.22)] rounded-2xl px-5 py-3 font-cinzel text-[0.68rem] text-[#c9a040] tracking-widest uppercase mt-6 mb-10">
          <span className="opacity-60">⊕ Bitcoin Mainnet · Ordinals Protocol</span>
